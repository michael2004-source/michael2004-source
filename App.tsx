...
const App: React.FC = () => {
  ...
  return (
    <div className="min-h-screen p-4 md:p-8 bg-slate-50 flex flex-col items-center">
      <nav className="max-w-5xl w-full flex justify-center items-center mb-8">
      ...
      <div className="max-w-5xl w-full grid grid-cols-1 lg:grid-cols-12 gap-8 items-start">
        <div className="lg:col-span-4 flex flex-col gap-6 lg:sticky lg:top-8">
          ...
          <div className="bg-white border border-slate-200 p-5 rounded-2xl shadow-sm">
             <h4 className="text-slate-900 font-bold text-xs uppercase tracking-widest mb-3 flex items-center gap-2">
               <i className="fa-solid fa-circle-info text-indigo-500"></i> How it works
             </h4>
             <p className="text-slate-500 text-[11px] leading-relaxed">
               This tool uses your device's high-quality local voices to help you master hearing numbers. 
               Adjust the range and speed to increase difficulty.
             </p>
          </div>
        </div>
        ...
        <main className="lg:col-span-8 flex flex-col h-full">
          ...
          <div className="bg-white rounded-3xl shadow-xl shadow-slate-200/50 border border-white p-6 md:p-12 flex-1 flex flex-col justify-center items-center relative overflow-hidden text-center min-h-[450px]">
            ...
            {!currentNumber ? (
              <div className="py-12 relative z-10 w-full animate-in fade-in zoom-in-95 duration-500">
                ...
                <h2 className="text-3xl font-black text-slate-800 mb-3">Auditory Mastery</h2>
                <p className="text-slate-500 mb-10 max-w-xs mx-auto font-medium">
                  Train your ears to recognize numbers in <span className="text-indigo-600 font-bold">{language.name}</span>.
                </p>
                <button
